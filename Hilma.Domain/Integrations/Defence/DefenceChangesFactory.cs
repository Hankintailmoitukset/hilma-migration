...
namespace Hilma.Domain.Integrations.Defence
{
    ...
    public class DefenceChangesFactory
    {
        ...
        private static void Object(NoticeContract notice, NoticeContract parent, List<Change> changes)
        {
            ...
            if (framework != null && parentFramework != null && (parentFramework.IncludesFrameworkAgreement || framework.IncludesFrameworkAgreement))
            {
                ...
                changes.Add(parentFramework.EstimatedTotalValue, framework.EstimatedTotalValue, typeof(ValueRangeContract), nameof(ValueRangeContract.Value), section: "II.1.4");
            ...
            changes.Add(parent.ProcurementObject.EstimatedValue, notice.ProcurementObject.EstimatedValue, typeof(ProcurementObject), nameof(ProcurementObject.EstimatedValue), section: "II.4");
            ...
            changes.Add(parent.ProcurementObject.Defence.TotalQuantityOrScope, notice.ProcurementObject.Defence.TotalQuantityOrScope, typeof(ValueRangeContract), nameof(ValueRangeContract.Value), section: "II.2.1");
            ...
            changes.Add(parent.ProcurementObject.Defence.Renewals.Amount, notice.ProcurementObject.Defence.Renewals.Amount, typeof(DefenceRenewals), nameof(DefenceRenewals.Amount));
            ...
            changes.Add(parent.ProcurementObject.TotalValue, notice.ProcurementObject.TotalValue, typeof(ValueRangeContract), nameof(ValueRangeContract.Value), section: "II.2");
        ...
        private static void HandleLotChanges(List<Change> changes, string lotNumber, ObjectDescription lot, ObjectDescription parentLot)
        {
            ...
            changes.Add(parentLot?.EstimatedValue, lot?.EstimatedValue, typeof(ValueContract), nameof(ValueContract.Value), lotNumber, "Annex B, 3");
        ...
        /// <param name="parent">The parent notice</param>
        /// <param name="changes">List of changes to append to</param>
        private void Conditions(NoticeContract notice, NoticeContract parent, List<Change> changes)
        {
        ...
        private static void Procedure(NoticeContract notice, NoticeContract parent, List<Change> changes)
        {
            ...
            // IV.3.6
            changes.AddEnum(parent.TenderingInformation.Defence?.LanguageType ?? LanguageType.Undefined, notice.TenderingInformation.Defence?.LanguageType ?? LanguageType.Undefined, typeof(DefenceAdministrativeInformation), nameof(DefenceAdministrativeInformation.LanguageType));
