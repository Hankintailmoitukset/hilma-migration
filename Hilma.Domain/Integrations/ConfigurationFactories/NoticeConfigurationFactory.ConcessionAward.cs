...
namespace Hilma.Domain.Integrations.ConfigurationFactories
{
    ...
    {
        private static NoticeContractConfiguration concessionAward = new NoticeContractConfiguration
        {
            ...
            ObjectDescriptions = new ObjectDescriptionConfiguration
            {
                ...
                AwardContract = new AwardConfiguration()
                {
                    ...
                    AwardedContract = new ContractAwardConfiguration()
                    {
                        ...
                        ConcessionRevenue = new ValueContractConfiguration()
                        {
                            Value = true,
                            Currency = true
                        },
                        PricesAndPayments = new ValueContractConfiguration()
                        {
                            Value = true,
                            Currency = true
                        },
            ...
            ProcurementObject = new ProcurementObjectConfiguration
            {
                ...
                EstimatedValueCalculationMethod = true,
