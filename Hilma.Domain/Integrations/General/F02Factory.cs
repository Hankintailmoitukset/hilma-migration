...
{
    /// <summary>
    /// TED F02 Contract Notice Factory - Generates TED integration XML
    /// </summary>
    public class F02Factory
    {
        ...
        public F02Factory(NoticeContract notice, string eSenderLogin, string tedESenderOrganisation,
        ...
        private XElement NoticeBody()
        {
            return TedHelpers.Element(
                       "FORM_SECTION", TedHelpers.Element(
                           "F02_2014", new XAttribute("LG", _notice.Language), new XAttribute("CATEGORY", "ORIGINAL"), new XAttribute("FORM", "F02"),
