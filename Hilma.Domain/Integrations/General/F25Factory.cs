...
namespace Hilma.Domain.Integrations.General
{
    ...
    public class F25Factory
    {
        ...
        /// <summary>
        /// F25 Concession Award Notice factory constructor.
        /// </summary>
        ...
        public F25Factory(NoticeContract notice, string eSenderLogin, string tedESenderOrganisation,
        ...
        private XElement NoticeBody()
        {
            return TedHelpers.Element(
                "FORM_SECTION", TedHelpers.Element(
                    "F25_2014", new XAttribute("LG", _notice.Language), new XAttribute("CATEGORY", "ORIGINAL"), new XAttribute("FORM", "F25"),
