...
namespace Hilma.Domain.DataContracts.EtsContracts
{
  ...
  public class EtsNoticeContract
  {
    ...
    public EtsNoticeContract(Notice dbo)
    {
      ...
      PublishToTed = dbo.TedPublishState > (int) TedPublishState.Undefined;
    ...
    public EtsNoticeContract(NoticeContract dto)
    {
      ...
      PublishToTed = dto.TedPublishState > (int) TedPublishState.Undefined;
    ...
    public ConditionsInformationNational ConditionsInformationNational { get; set; } =
      new ConditionsInformationNational();
    ...
    /// <summary>
    ///     If this described notice should be published to TED. If not, it will only be published nationally
    ///     to Hilma.
    /// </summary>
